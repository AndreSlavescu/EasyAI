...
if __name__ == "__main__":
    ...
    print(f"Sequence output shape: {sequence_output.shape}")  # Should be [batch_size, seq_length, hidden_size]
    print(f"Pooled output shape: {pooled_output.shape}")     # Should be [batch_size, hidden_size]
